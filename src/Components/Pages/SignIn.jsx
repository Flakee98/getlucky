          ...
          <Card className="shadow" style={{backgroundColor: "#102042"}}>
            <Card.Body>
              <div className="mb-3 mt-md-4">
                <h2 className="fw-bold mb-2 text-uppercase  text-white  text-center">SIGIN IN</h2>
                <div className="mb-3">
                  <Form className='text-white'>

                  <div class="row">
                    
                    <Button variant="primary bg-white text-dark " className="mb-3 col" onClick={ EmailClick}>Email</Button>{' '}
                     
                    <Button variant="primary" className="mb-3 col" onClick={ MobilelClick}>Mobile</Button>{' '}
